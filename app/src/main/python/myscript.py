...
def main(num1, num2):
    # num1 - это вус, num2 - это рост
    # используется некоторое смещение для удобства
    # print(mse_loss(y_true, y_pred)) - это покажет вероятность правильного ответа
    res1 = (num1 - 145) / 2.2
    res2 = (num2 - 76) / 2.54
    emily = np.array([res1, res2])
    return_value = ""
    if network.feedforward(emily) < 0.5:
        return_value = "Мужчина"
    else:
        return_value = "Женщина"
    return return_value
